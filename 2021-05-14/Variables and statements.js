...
*/
	...
	var entValue = +prompt('Введите что угодно и узнайте число ли это?', entValue);
	var convNum = isNaN(entValue);
	var typeOfData = typeof convNum; 
	alert('true - значит число \nfalse - значит строка \nРезультат: ' + Boolean(typeOfData));
